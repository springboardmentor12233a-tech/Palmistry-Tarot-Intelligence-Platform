  ...
  head: () => ({
    meta: [
      ...
      { title: "Palmistry & Tarot Intelligence Platform" },
      {
        name: "description",
        content:
          "AI palm biometrics fused with tarot symbolism into deep, exportable readings.",
      },
      { property: "og:title", content: "Palmistry & Tarot Intelligence Platform" },
      {
        property: "og:description",
        content: "Palm landmark segmentation, tarot spreads and multimodal AI interpretation.",
      },
